...
// TODO: put the value in package settings somehow
// development purposes, the dev github repository is not in /.atom ( but a shortcut is)
const b_DEV= false; 
const emmet= b_DEV?require('../../../.atom/packages/emmet/node_modules/emmet/lib/emmet.js'):require('../../emmet/node_modules/emmet/lib/emmet.js');

import AtomEmmetdraftParserView from './atom-emmet-draft-parser-view';
import {CompositeDisposable}    from 'atom';

/*
 copy paste of the default profile of the emmet repository https://github.com/emmetio/emmet
 as it is not a substantial portion of the software, it should be permitted, MIT licence
 TODO : more research to import this const
 */
const profile= {
  tag_case: 'asis',
  attr_case: 'asis',
...
{ atomEmmetdraftParserView: null,
  ...
  { this.atomEmmetdraftParserView= new AtomEmmetdraftParserView(state.atomEmmetdraftParserViewState);
    this.modalPanel              = atom.workspace.addModalPanel({ item   : this.atomEmmetdraftParserView.getElement(),
                                                                  visible: false});
    // Events subscribed to in atom's system can be easily cleaned up with a CompositeDisposable
    this.subscriptions           = new CompositeDisposable();
    // Register command that minify
  ...
  serialize ()
  { return { atomEmmetdraftParserViewState: this.atomEmmetdraftParserView.serialize()}; },

  minify ()
  { console.log('Emmet-draft-Parser > minified selected text!');
